...
public class blueTopAuto extends OpMode {
    ...
    private static final Pose startPos = new Pose(120.685, 127.204, Math.toRadians(126)).mirror();
    private Paths paths;
    private int state = 0;
        ...
        public Paths(Follower follower) {
            Path1 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(103.435, 109.617).mirror()
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(52))
            ...
            Path2 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(103.435, 109.617).mirror(),
                                    new Pose(84.826, 81.181).mirror(),
                                    new Pose(122.901, 83.385).mirror()
                            )
            ...
            Path3 = follower.pathBuilder().addPath(
                            new BezierLine(
                                    ...
                                    new Pose(103.215, 109.526).mirror()
                            )
            ...
            Path4 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(103.215, 109.526).mirror(),
                                    new Pose(90.730, 66.781).mirror(),
                                    new Pose(81.024, 61.160).mirror(),
                                    new Pose(108.364, 58.694).mirror(),
                                    new Pose(129.369, 58.687).mirror()
                            )
                    ).setConstantHeadingInterpolation(Math.toRadians(180))
            ...
            Path5 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    new Pose(129.369, 58.687).mirror(),
                                    new Pose(78.984, 41.512).mirror(),
                                    new Pose(93.075, 83.093).mirror(),
                                    new Pose(103.448, 109.504).mirror()
                            )
